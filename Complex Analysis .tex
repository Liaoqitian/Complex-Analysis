...
\begin{figure}[h]
\includegraphics[scale=0.2]{Laurentsine} 
\centering
\end{figure}
\\
\newpage
...
$$ P.V. \int_b^a f(x) \, dx = \lim_{\epsilon \to 0^+}\left(\int_{a}^{c - \epsilon}f(x) \, dx + \int_{c + \epsilon}^b f(x) \right)$$
\begin{figure}[h]
...
& = \lim_{\epsilon \to 0^+} {\int_{-2}^{-\epsilon} f(x)\, dx + \int_{\epsilon}^3 f(x) \, dx} \\
& = \lim_{\epsilon \to 0^+} {F(3) - F(\epsilon) + F(-\epsilon) - F(-2)} \\
& = \lim_{\epsilon \to 0^+} {F(3) - F(-2)} \\
...
\newline
\textbf{Example.} The improper integral 
...
\begin{figure}
\includegraphics[scale=0.3]{21_2} 
\centering
\end{figure}
\newline
\newpage
...
\Rightarrow \abs*{\int_{C_R}f(z) \, dz} &\leqslant \int_{C_R}|f(z)||dz| \leqslant \frac{A}{R^4}\pi R = \frac{A\pi}{R^3}
\end{align*}
\newpage
