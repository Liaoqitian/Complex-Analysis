...
\begin{figure}[h]
\includegraphics[scale=0.17]{22_1} 
\centering
\end{figure} 
\\
...
Let $\gamma_2$ be a circle of radius 1, and it passes through the root -1. Therefore, the Argument Principle fails. \\ 
\newline
...
On $|z| = 2$, let $f = z^7$, $h = -5z^3 + 12$. $|f| \leqslant 128, |h| \leqslant 52$. So on $f$ and $f + h$ have the same number of roots on $|z| < 2$, which is 7. \\
