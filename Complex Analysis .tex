...
\newline
\textbf{Cauchy Integral Formula. (C.I.F)} \\
...
\newline 
\newline
\textbf{Extension of Cauchy Integral Formula.} \\
Cauchy Integral Formula can be naturally expanded to $f'(z)$, 
...
We want to express holomorphic functions in $\mathbb{C}$ by series in $z$ instead of integrals and the Cauchy Riemann Equations. 
